...
export default function Workspace() {
  ...
  const ready = drafts.filter(e => e.ready_to_send && e.status === "ready" && e.approved_by === mailbox?.object_id && e.approved_mailbox === (mailbox?.mailbox_key || mailbox?.object_id));
